...
## Aritic Setup
The API must be enabled in Aritic. Within Aritic, go to the Configuration page (located in the Settings menu) and under API Settings enable
Aritic's API. If you intend on using Basic Authentication, ensure you enable it. You can also choose which OAuth protocol to use here.  After saving the configuration, go to the API Credentials page
...
The first step is to obtain authorization.  Aritic supports OAuth 1.0a and OAuth 2 however it is up to the administrator
...
$settings = array(
    'baseUrl'          => '',       // Base URL of the Aritic instance
    'version'          => 'OAuth2', // Version of the OAuth can be OAuth2 or OAuth1a. OAuth2 is the default value.
    'clientKey'        => '',       // Client/Consumer key from Aritic
    'clientSecret'     => '',       // Client/Consumer secret key from Aritic
...
// and the base URL to the Aritic server (i.e. http://my-aritic-server.com/api/)
...
See the [developer documentation](https://developer.aritic.org).
...
Configure the unit tests config before running the unit tests. The tests fire real API requests to a Aritic instance.
...
3. Fill in the URL of your Aritic instance. NOTE: if you're using Docker/DDEV and your Aritic instance is running in another container, use the container name instead of the FQDN of your Aritic instance, e.g. http://aritic-instance/...
