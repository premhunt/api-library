...
if (isset($_SESSION['redirect'])) {
    ...
    if ($valid) {
        ...
        $oauthObject = \Aritic\Auth\ApiAuth::initiate(
            array(
    ...
    <form action="index.php" method="POST">
        ...
        <div class="row">
            <div class="col-lg-5" style="padding-right: 0px !important;">
                <input class="form-control custom-right" type="text" value="<?php echo $apiurl; ?>" placeholder="Aritic URL" name="apiurl">
            </div>
