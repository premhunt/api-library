...
use Aritic\Exception\AuthorizationRequiredException;
use Aritic\Exception\IncorrectParametersReturnedException;
...
class OAuth extends AbstractAuth
{
    ...
    /**
     * @param string $baseUrl URL of the Aritic instance
    ...
    protected function getQueryParameters($isPost, $parameters)
    {
        ...
        if (isset($parameters['file'])) {
            // Aritic's OAuth2 server does not recognize multipart forms so we have to append the access token as part of the URL
    ...
    protected function requestAccessToken($method = 'POST', array $params = array(), $responseType = 'flat')
    {
        ...
        if (is_array($params)) {
            if (isset($params['errors'])) {
                ...
                // @deprecated support for pre Aritic 2.6.0
